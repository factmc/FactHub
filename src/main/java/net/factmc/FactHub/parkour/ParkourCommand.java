    		...
    		if (args.length > 0) {
    			...
    			if (args[0].equalsIgnoreCase("time")) {
    				...
    				if (args.length > 1) {
    					...
    					int tickTime = FactSQLConnector.getIntValue(FactSQLConnector.getStatsTable(), uuid, "PARKOURTIME");
						...
						int tickTime = FactSQLConnector.getIntValue(FactSQLConnector.getStatsTable(), player.getUniqueId(), "PARKOURTIME");
